...
const API = "http://us1.locationiq.com/v1/search.php";
const locations = [
  "Great Wall of China",
  "Petra",
  "Colosseum",
...
//     .catch((error) => {
//       console.log(
//         `there has been an error in getInfo for ${location}. Cause: ${error}`
//       );
//     });
// };
...
//   const currentPromise = getPromise((i + 1) * 3);
//   currentPromise
//     .then((value) => {
//       getInfo(location);
//     })
//     .catch((error) => {
//       console.log(`there has been an error in the for loop: ${error}`);
//     });
// }
